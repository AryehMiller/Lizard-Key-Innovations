...
## Conduct adaptive sampling using hisse::SupportRegionMuHiSSE
...
Relaxed.Standard.MuH.CID8.AdaptiveSampling <- SupportRegionMuHiSSE(muhisse.obj = Relaxed.Standard.MuH.CID8, n.points = 10000, scale.int = 0.05)
Relaxed.Full.MuH.CID8.AdaptiveSampling <- SupportRegionMuHiSSE(muhisse.obj = Relaxed.MuH.CID8, n.points = 10000)
...
## Relaxed Full
Relaxed.Full.MuH.CID8.AdaptiveSampling <- Relaxed.Full.MuH.CID8.AdaptiveSampling
